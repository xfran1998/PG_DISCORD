...
const quizzGame = [
  {
    titulo: "¿Quien es el mejor piloto de TXS?",
    respuestas: ["Volvo (Obvio que no)", "Turko", "Hydrax", "franelguay <--"],
    correcta: 3,
  },
  {
    titulo: "¿Quien es el mas peke de txs?",
    respuestas: ["Almu", "AOI", "jose", "termi"],
    correcta: 0,
  },
  {
    titulo: "¿Cuantas conquistas ha ganado jefetribu en los últimos 10 días?",
    respuestas: ["0", "1", "2", "3"],
    correcta: 2,
  },
];
